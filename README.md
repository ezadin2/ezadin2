<div style="background: #0a0a12; color: #00ff00; padding: 40px; font-family: 'Courier New', monospace; border: 1px solid #333; box-shadow: 0 0 10px #00ff00;">
  <!-- Terminal-style header -->
  <div style="border: 1px solid #00ff00; padding: 20px; margin-bottom: 30px; background: #000;">
  ...
  <div style="margin-bottom: 30px;">
    ...
    <ul style="list-style-type: none; padding: 0;">
      ...
      <li><span style="color: #4af626;">>></span> 💻 Tech Stack: Flutter | Dart | Firebase | Node.js | Python</li>
      <li><span style="color: #4af626;">>></span> ⚡ Fun Fact: I can debug complex issues while drinking coffee ☕</li>
    </ul>
  </div>
  ...
  <div style="margin-bottom: 30px;">
    ...
    <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ezadin2&layout=compact&theme=dark&bg_color=0a0a12&title_color=4af626&text_color=00ff00" alt="Top Languages" style="width: 100%; margin-top: 20px;"/>
  </div>
