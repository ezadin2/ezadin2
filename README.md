<div style="display: flex; align-items: center; justify-content: flex-start; gap: 20px; position: relative;">
  ...
  <div style="font-family: 'Poppins', sans-serif; color: #E0E0E0; font-size: 24px; white-space: nowrap; 
  ...
  <div style="font-family: 'Poppins', sans-serif; color: #E0E0E0; font-size: 24px; white-space: nowrap; 
              opacity: 0; animation: fadeInOut 5s ease-in-out 1s forwards;">
